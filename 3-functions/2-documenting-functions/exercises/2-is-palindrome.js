...
/**
 * tell if a given string is a palindrome or not
 *
 * @param {string} [toCheck=''] - the string to check if is palindrome
 * @return {boolean} a boolean expression that confirm or not if is a palindrome
 */
